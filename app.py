...
if uploaded_image is not None:
    ...
    if model_choice == "PyTorch":
        ...
        #st.warning("ONNX model output is raw and not post-processed.")
        st.info("Please select the PyTorch model for full detection with bounding boxes. The ONNX model will be included in our future work")
